        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  width: 94,
                  child: Center(
                    child: Text("Beer", style: TextStyle(color: Colors.white)),
                  ),
                  decoration: BoxDecoration(
                    color: Color(0xFF272220),
                    borderRadius: BorderRadius.circular(200),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      image: DecorationImage(
                        image: AssetImage("assets/Group 12624 (1).png"),
                      ),
                    ),
                    child: Column(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      image: DecorationImage(
                        image: AssetImage("assets/Group 12624.png"),
                      ),
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.end,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      image: DecorationImage(
                        image: AssetImage("assets/Group 12539 (2).png"),
                      ),
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.end,
            ...
            Padding(
              ...
              child: Text(
                "See more?",
                style: TextStyle(color: Color(0xFF272220)),
              ),
            ),
          ],
        ),
